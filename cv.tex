...
\Huge{Elliot Britton} \\[7.5pt]
\href{https://github.com/ebritt07}{\raisebox{-0.05\height}\faGithub\ ebritt07} \ $|$ \ 
\href{https://linkedin.com/in/elliotbritton}{\raisebox{-0.05\height}\faLinkedin\ elliotbritton} \ $|$ \ 
\href{https://mysite.com}{\raisebox{-0.05\height}\faGlobe \ mysite.com} \ $|$ \ 
\href{mailto:email@mysite.com}{\raisebox{-0.05\height}\faEnvelope \ email@mysite.com} \ $|$ \ 
\href{tel:+41531034000}{\raisebox{-0.05\height}\faMobile \ +01.415.310.3400} \\
\end{tabularx}
...
\textbf{Software Engineer} & \hfill Jan 2021 - present \\[3.75pt]
\multicolumn{2}{@{}X@{}}{Backend engineer}  \\
\end{tabularx}
